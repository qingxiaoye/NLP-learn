...
def keywords_extraction(text):
    ...
    tr4w = TextRank4Keyword(allow_speech_tags=['n', 'ns', 'nz', 'nr', 'v', 'vn', 'gg'])
...
if __name__ == "__main__":
    ...
    #        "正式将该小行星命名为“周又元星”。"
    text = '女士，您可以带上您的身份证去附近的营业厅，向工作人员帮您帮您补办一张"'
    # 关键词抽取
    keywords_TextRank4Keyword = keywords_extraction(text)
    print('TextRank4Keyword关键词抽取',keywords_TextRank4Keyword)
    # 关键词抽取
    keywords_jieba = keywords_textrank(text)
    print('jieba关键词抽取',keywords_jieba)
    # 关键短语抽取
